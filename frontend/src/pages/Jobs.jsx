    ...
    <>
      ...
      <section>
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="top-[200px] mx-auto max-w-2xl rounded-3xl bg-darkGrey ring-1 ring-gray-200 lg:mx-0 lg:flex lg:max-w-none">
            <div className="p-8 text-center lg:flex-auto">
              <div className="lg:mx-40 lg:my-6 min-[360px]:mx-0 min-[360px]:my-0">
                <h2 className="text-xl font-bold tracking-tight text-gray-900 sm:text-3xl">
                  Cari <span className="text-primary">pekerjaan</span> yang Kamu
                  inginkan
                </h2>
                ...
                <div className="bg-white flex rounded-md shadow-md justify-between mt-12 p-[10px] min-[360px]:flex-wrap">
                  <div className="mr-5 self-center">
                    <form className="flex p-2">
                      ...
                      <select
                        name=""
                        id="relevance"
                        className="gb-white text-gray-600 rounded-[3px]">
                        <option value="">Management</option>
                        <option value="">Finance</option>
                        <option value="">Retail & Products</option>
                  ...
                  <div className="mr-5 self-center">
                    <form className="flex p-2">
                      ...
                      <select
                        ...
                        name=""
                        id="relevance"
                        className="gb-white text-gray-600 rounded-[3px] w-[7rem]">
